...
export default function KeyTermsSection() {
  ...
  const terms = [
    { icon: <HashIcon />, bg: "bg-yellow-50", title: t("wonTitle"), desc: t("wonDesc") },
    { icon: <QuestionIcon />, bg: "bg-green-50", title: t("enquiryPurposeTitle"), desc: t("ccrEnquiryPurposeDesc") },
    { icon: <CalendarIcon />, bg: "bg-purple-50", title: t("enquiryDateTimeTitle"), desc: t("ccrEnquiryDateTimeDesc") },
  ];
